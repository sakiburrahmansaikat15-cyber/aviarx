...
export default function AboutPage() {
  return (
    <PageTransition>
      ...
      {/* Hero */}
      <section style={{ background: "#0a0a0a", padding: "60px 48px 80px", textAlign: "center" }}>
        <div style={{ fontSize: "10px", letterSpacing: "0.25em", textTransform: "uppercase", color: "#c9a96e", marginBottom: "16px" }}>Our Story</div>
        <h1 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(48px,6vw,88px)", fontWeight: 300, color: "#fafaf8", lineHeight: 1.1 }}>
          Designed with <em>intention</em>.<br />Built to last.
        </h1>
      </section>

      {/* Story */}
      <section style={{ background: "#fafaf8", padding: "60px 48px" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(22px,2.5vw,32px)", fontWeight: 300, lineHeight: 1.6, color: "#0a0a0a", marginBottom: "40px" }}>
      ...
      {/* Stats */}
      <section style={{ background: "#f5f2ec", padding: "80px 48px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "48px", textAlign: "center" }}>
          {[["5+", "Years of Craft"], ["100%", "Ethical Sourcing"], ["98%", "Customer Satisfaction"]].map(([num, label]) => (
            <div key={label}>
              <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "56px", fontWeight: 300, color: "#c9a96e", lineHeight: 1 }}>{num}</div>
      ...
      <section style={{ background: "#0a0a0a", padding: "120px 48px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "72px" }}>
            ...
            <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,56px)", fontWeight: 300, color: "#fafaf8" }}>Our <em>Values</em></h2>
          </div>
